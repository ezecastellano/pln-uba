...
Esta clase ten\'ia implementado el m\'etodo toString de la al estilo xml, \textless regla\textgreater  token \textless /regla \textgreater y de esta forma podíamos formar archivos en un formato que pusimos extensión ".tok" que nos permitía realizar un análisis en base a las expresiones regulares que se aplicaron.
