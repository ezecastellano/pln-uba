...
\begin{enumerate}
	...
	\begin{itemize}
		\item \texttt{train}: archivos de entrenamiento.
				...
				\item posttag.train: versión en el formato de OpenNLP para entrenamiento de postagging.
		...
		\item \texttt{bin}: modelos entrenados con los distintos archivos de train.	
			\begin{itemize}
				\item es-AA-chunker.bin: modelo de chunking entrenado con AA.train.
				\item es-A-chunker.bin: modelo de chunking entrenado con A.train.
				\item es-chunker.bin: modelo de chunking entrenado con all.train.
				\item es-P-chunker.bin: modelo de chunking entrenado con P.train.
				\item es-pos-maxent.bin: modelo de posttaging con maxent entrenado sobre posttag.train.
			\end{itemize}
		\item \texttt{textos}: textos seleccionados del español en sus diferentes formatos.
			\begin{itemize}
				\item boson:
					\begin{itemize}
						\item higgs : fragmento original del artículo seleccionado.
						\item higgs.tokenized
						\item higgs.postagged
						\item higgs.chunked 
					\end{itemize}	
				\item lic:
					\begin{itemize}
						\item lic-cs : fragmento original del artículo seleccionado.
						\item lic-cs.tokenized
						\item lic-cs.postagged
						\item lic-cs.chunked 
					\end{itemize}
			\end{itemize}	
	\end{itemize}				
