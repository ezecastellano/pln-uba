...
En el caso de Genia es destacable que la principal y mayor causa de error es NN y NNP. Y en relación ambos es relevante que alrededor del 0.15 se deben a JJ y NN.
