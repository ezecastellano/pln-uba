...
won't ==> ['will', "n't"]
etc.
Considere que la forma 's (genitivo) no es una contracción en frases como John's book.  
En estos casos su tokenizador debe separar 's de la palabra en la que aparece.
*/